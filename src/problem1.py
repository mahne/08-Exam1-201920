...
def problem1(square, thickness, window):
    ...
    circle = rg.Circle(square.center,square.length_of_each_side/2)
    circle.center.y += square.length_of_each_side
    circle.fill_color = square.fill_color
    circle.outline_thickness = thickness
    circle.attach_to(window)

    p2 = rg.Point(square.center.x-square.length_of_each_side/2,square.center.y)
    line = rg.Line(circle.center,p2)
